...
<html>
<head>
<title>Maxifalcone.org | Adalberto LetradeMolde</title>
<!-- for-mobile-apps -->
...
<body class="galeria-portfolio adalberto">
<!-- header -->
...
<!-- banner -->
	<div class="banner cabecera">
							...
							<div class="inner-banner" style="width:100%;background-image:url(../images/cabecera_adalberto.jpg)">
...
<!-- //banner -->
<!-- portfolio -->
<h1>Adalberto LetradeMolde</h1>
	<div id="portfolio" class="portfolio">
		<div class="container">
			
			<p class="vel">Tira que se publicaba en la revista La Negra del Sur</p>
			<div class="sap_tabs">			
					...
					<div class="resp-tabs-container">
							...
							<div class="main">
								<?php 
									...
									$params = array(
											'api_key'		 => 'db3689fc2080ce0a177e69396c345b89',
											'secret'		 => 'd773c1294430f4d1',
											'method'		 => 'flickr.photos.search',
											'format'		 => 'rest',
											'user_id'		 => '49067600@N03',
											'tags'			 => 'adalbertoletrademolde',
