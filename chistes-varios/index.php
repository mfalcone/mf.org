...
<html>
<head>
<title>MaxiFalcone.org | Chistes Varios</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Ilustración, historieta, humor gráfico, chistes" />
...
<!-- banner -->
	<div class="banner cabecera">
							...
							<div class="inner-banner" style="width:100%;background-image:url(../images/cabecera_chistes_varios.jpg)">
									
							</div>
			<div class="grilla"></div>
	</div>
<!-- //banner -->
<h1>Chistes Varios</h1>
<!-- portfolio -->
	<div id="portfolio" class="portfolio">
		<div class="container">
			
			<p class="vel">Chistes publicados en varios medios diferentes. Entre los que se destaca Catrasca y La negra del Sur entre otros. </p>
			<div class="sap_tabs">			
											...
											<div class="view effect">
												<div class="img-top">
													<a href="<?php echo $entry['url_l'] ;?>" rel="<?php echo $title ?>" class="b-link-stripe b-animate-go  thickbox">
														<img src="<?php echo $entry['url_o'] ;?>" class="img-responsive" alt="" />
														<div class="mask"></div>
														<div class="content">
