...
<html>
<head>
<title>Maxifalcone.org | Esquizomedia</title>
<!-- for-mobile-apps -->
...
<body class="galeria-portfolio esquizomedia">
<!-- header -->
...
<!-- banner -->
	<div class="banner cabecera">
							...
							<div class="inner-banner" style="width:100%;background-image:url(../images/cabecera_esquizomedia.jpg)">
...
<!-- portfolio -->
	<div id="portfolio" class="portfolio">
		<div class="container">
			<p class="vel">Historieta de 8 a 10 páginas por capítulo. Puede leerse completo <a href="http://esquizomedia.com" target="_blank">aquí</a></p>
			<div class="sap_tabs">			
